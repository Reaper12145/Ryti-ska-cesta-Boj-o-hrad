...
namespace Rytirskacestabojohrad
{
    internal class bytost
    {
        ...
        virtual public int PenizeMinus150()
        {
            penize = (penize - 150);
            Console.WriteLine("Aktualni zustatek: ", penize);
            return penize;
        ...
        virtual public int PatnastaCast()
        {
            Console.WriteLine("{0} ...", jmeno);
            return 0;
        }
        virtual public int SestnastaCast()
        {
            Console.WriteLine("{0} ...", jmeno);
            return 0;
        }
        virtual public int SedmnastaCast()
        {
            Console.WriteLine("{0} ...", jmeno);
            return 0;
        }
        virtual public int OsmnastaCast()
        {
            Console.WriteLine("{0} ...", jmeno);
            return 0;
        }
        virtual public int DevatenastaCast()
        {
            Console.WriteLine("{0} ...", jmeno);
            return 0;
        }
