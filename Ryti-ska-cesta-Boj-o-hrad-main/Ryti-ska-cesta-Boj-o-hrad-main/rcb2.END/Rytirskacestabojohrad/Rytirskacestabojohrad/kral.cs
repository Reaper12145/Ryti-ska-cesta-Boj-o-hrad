...
namespace Rytirskacestabojohrad
{
    internal class kral : bytost
    {
        ...
        //Král: Mockrát vám děkuji. Řekněte jak se vám mám tentokrát odměnit?
        ...
        public override int DesataCast()
        {
            ...
            Console.WriteLine("{0}: Mockrát vám děkuji. Řekněte jak se vám mám tentokrát odměnit?", jmeno);
            Thread.Sleep(1000);
            Console.WriteLine("1. Nic");
            Thread.Sleep(1000);
            Console.WriteLine("2. celé království");
            Thread.Sleep(1000);
            Console.WriteLine("3. královninu ruku");
            Thread.Sleep(1000);
            Console.WriteLine("4. Samsung Galaxy S23 Ultra");
            return 0;
        }
