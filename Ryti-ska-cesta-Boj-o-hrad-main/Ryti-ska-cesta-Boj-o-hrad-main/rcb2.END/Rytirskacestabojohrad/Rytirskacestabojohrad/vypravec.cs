...
namespace Rytirskacestabojohrad
{
    internal class vypravec:bytost
    {
        ...
        public override int PenizeMinus150()
        {
            penize = -150;
            return penize;
        }
        ...
        public override int DevataCast()
        {
            ...
            Thread.Sleep(4000);
            PenizePlus500();
            Console.WriteLine("Aktualni zustatek: {0} zł", penize);
            return 0;
        }
        ...
        //Vypravěč: Stvůry se v noci přiblížili k tábořišti rytířů, ale prozradili se ještě před tím než se stačili dostat na svoje útočné pozice.
        ...
        public override int JedenastaCast()
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: Stvůry se v noci přiblížili k tábořišti rytířů, ale prozradili se ještě před tím než se stačili dostat na svoje útočné pozice. ", jmeno);
            Thread.Sleep(1000);
            Console.WriteLine("1.Zaútočit na stvůry dokud nejsou připraveni");
            Thread.Sleep(1000);
            Console.WriteLine("2.Začít zdrahat, protože nejste připraveni na souboj.");
            Thread.Sleep(1000);
            Console.WriteLine("3.Připravit rychlou protiofenzívu.");
            Thread.Sleep(4000);
            return 0;
        }
        //Vypravěč: I když se ztrátami, tak jste jim zdrhli a znovu se seskupili.A feudál si vyžádal pozornost svých rytířů.
        public override int DvanastaCast()
        {
            Console.WriteLine("Aktualni zustatek: {0} zł", penize);
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: I když se ztrátami, tak jste jim zdrhli a znovu se seskupili.A feudál si vyžádal pozornost svých rytířů.", jmeno);
            return 0;
        }
        //Vypravěč: I když se ztrátami, tak jste jim zdrhli a znovu se seskupili. A feudál si vyžádal pozornost svých rytířů.
        public override int TrinastaCast()
        {
            Console.WriteLine("Aktualni zustatek: {0} zł", penize);
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: I když se ztrátami, tak jste jim zdrhli a znovu se seskupili. A feudál si vyžádal pozornost svých rytířů.", jmeno);
        ...
        //Vypravěč: Po dlouhé a vyčerpávající cestě Sir Roland dorazil k mocnému čaroději.
        ...
        public override int PatnastaCast()
        {
            Console.WriteLine("Aktualni zustatek: {0} zł", penize);
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: Po dlouhé a vyčerpávající cestě Sir Roland dorazil k mocnému čaroději.", jmeno);
            Thread.Sleep(1000);
            Console.WriteLine("1. Poprosit čaroděje o pomoc");
            Thread.Sleep(1000);
            Console.WriteLine("2. Nabídnou čaroději za pomoc 300zł");
            Thread.Sleep(1000);
            Console.WriteLine("3. Slíbit čaroději nadválu nad královstvím");
            return 0;
        }
        //Vypravěč: Sir Roland společně s novým spojencem se připojili k feudálovi a na zítřejší poledne naplánovali ohromující útok.
        ...
        public override int SestnastaCast()
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: Sir Roland společně s novým spojencem se připojili k feudálovi a na zítřejší poledne naplánovali ohromující útok.", jmeno);
            Thread.Sleep(1000);
            Console.WriteLine("1. Obklíčit je a nechat čaroděje dělat co uzná za vhodné");
            Thread.Sleep(1000);
            Console.WriteLine("2. Postavit čaroděje do první linie a rozběhnout se proti nim");
            Thread.Sleep(1000);
            Console.WriteLine("3. Nahnat je do rokliny, kde bude čekat čaroděj, který je zmasakruje");
            return 0;
        }

        //Vypravěč: Výborně všichni nepřátelé jsou pobiti, ale co s čarodějem? 
        ...
        public override int SedmnastaCast()
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: Výborně všichni nepřátelé jsou pobiti, ale co s čarodějem?", jmeno);
            Thread.Sleep(1000);
            Console.WriteLine("1. Dát čaroději to se mu slíbilo");
            Thread.Sleep(1000);
            Console.WriteLine("2. Dát čaroději 300zł a vyprovodit ho");
            Thread.Sleep(1000);
            Console.WriteLine("3. Zabít čaroděje než bude cokoliv požadovat");
            return 0;
        }
        //Vypravěč: Feudál spolu se svými rytíři se vydá oznámit vítězství královi.
        public override int OsmnastaCast()
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: Feudál spolu se svými rytíři se vydá oznámit vítězství královi.", jmeno);
            Thread.Sleep(1000);
            return 0;

        }
        //Vypravěč: Král se pokusí zpoza pasu vytáhnout světelný meč, ale ty máš rychlejší reflexe a tak královi useknete hlavu a vezmeš si jeho korunu a prohlásil se za nového krále. 
        //Lidu se to sice nelíbí ale už nikdo kdo by vás mohl porazit nezbyl a tak se všichni poddají.

        public override int DevatenastaCast()
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("{0}: Král se pokusí zpoza pasu vytáhnout světelný meč, ale ty máš rychlejší reflexe a tak královi useknete hlavu a vezmeš si jeho korunu a prohlásil se za nového krále. \r\n", jmeno);
            Thread.Sleep(3000);
            Console.WriteLine("{0}: Lidu se to sice nelíbí ale už nikdo kdo by vás mohl porazit nezbyl a tak se všichni poddají.", jmeno);
            return 0;
